...
TOP_K = [1, 3, 5, 10]
MODEL_NAMES = ["AITeamVN_bge-reranker-v2-m3"]
RESULTS_INPUT_PATHS: Dict[str, Dict[int, Path]] = {
    model_name: {
        top_k: Path(f"data/Result_by_Dense_Rerank/{model_name}/result_by_top{top_k}.jsonl")
        for top_k in TOP_K
    }
...
RESULTS_OUTPUT_DIR = Path("benchmark/results_of_experiments/by_Dense_Rerank")
